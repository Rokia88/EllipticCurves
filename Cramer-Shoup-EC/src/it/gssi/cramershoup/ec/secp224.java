...
public class secp224 implements ECParameters {
    ...
    private static final BigInteger msgx
       ...
       private static final BigInteger gx2
      	= new BigInteger("15004584660196003017601902720627048453358942200064310228102459960602", 10);

          private static final BigInteger gy2
          	= new BigInteger("15235944292863266539874019808915937928092586996807711069271801853280", 10);
